...
- [邮箱验证系统](./EMAIL_AUTH.md) - 昵称-邮箱绑定机制
- [实时同步优化](./REALTIME_SYNC.md) - 高频游戏画面推送
- [防作弊系统](./ANTI_CHEAT.md) - 服务端方块控制和作弊检测
- [难度递增系统](./DIFFICULTY_SYSTEM.md) - 动态难度调整机制
- [自动断连检测](./AUTO_DISCONNECT_DETECTION.md) - 异常断连自动结束游戏
- [验证码配置指南](./CAPTCHA_CONFIG.md) - 详细的验证码频率配置说明
- [验证码快速配置](./CAPTCHA_QUICK_CONFIG.md) - 一键配置方案
